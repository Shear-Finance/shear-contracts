...
module.exports = {
  ...
  hardhat: {
    forking: {
      url: "https://eth-mainnet.alchemyapi.io/v2/aE_kYsizNYWhqZ18ryeMsl-JkWmCMgFj",
    ...
    rinkeby: {
      url: "https://eth-rinkeby.alchemyapi.io/v2/aE_kYsizNYWhqZ18ryeMsl-JkWmCMgFj", // <---- YOUR INFURA ID! (or it won't work)
  ...
  solidity: {
	...
	overrides: {
		//'@uniswap/v2-periphery/contracts/libraries/UniswapV2Library.sol': UNISWAP_SETTING,
	}
  },
  ovm: {
    solcVersion: "0.7.6",
